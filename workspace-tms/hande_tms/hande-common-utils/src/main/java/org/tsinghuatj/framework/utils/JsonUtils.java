...
public final class JsonUtils {
	...
	static {
		...
		gb.registerTypeAdapter(java.lang.Long.class, new LongDeserializer());
		gb.registerTypeAdapter(java.lang.Long.class, new LongSerialize());
		gson = gb.create();
	}

	static class LongDeserializer implements JsonDeserializer<java.lang.Long> {
	...
	static class LongSerialize implements JsonSerializer<java.lang.Long> {
