...
import org.tsinghuatj.framework.utils.excel.handler.ExcelTemplate;
import org.tsinghuatj.framework.utils.excel.utils.Utils;

public class ExcelUtils {

    private static volatile ExcelUtils excelUtils = null;
    ...
    public byte[] exportObjects2ExcelByteArray(List<?> data, Class<?> clazz, boolean isWriteHeader, String sheetName, boolean isXSSF) throws Exception {
