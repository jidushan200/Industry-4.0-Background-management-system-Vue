...
public class StaffDepartment implements Serializable {
	...
	/**
	 * @Fields department_code : 部门编码
	 */
	@ExcelField(title = "部门编码", order = 1)
	@ApiModelProperty(name = "departmentCode", notes = "部门编码")
	...
	public String toString() {
		return "StaffDepartment " + "[pkId=" + pkId + "]" + ",[createUser=" + createUser + "]" + ",[createTime=" + createTime + "]" + ",[updateUser=" + updateUser + "]" + ",[updateTime=" + updateTime + "]" + ",[delMark=" + delMark + "]" + ",[departmentCode=" + departmentCode + "]" + ",[departmentName=" + departmentName + "]";
	}
}
