<template>
  <div>
    ...
    <fixture-return-modal ref="fixtureReturnModal" @search="getListData"></fixture-return-modal>
  </div>
</template>
...
import fixtureReturnModal from "./fixture-return-modal.vue";
export default {
  components: {
    fixtureReturnModal
  },
  ...
  methods: {
    ...
    fixtureReturn(row) {
      const self = this;
      self.$refs.fixtureReturnModal.showModal(row);
    }
  }
};
</script>
