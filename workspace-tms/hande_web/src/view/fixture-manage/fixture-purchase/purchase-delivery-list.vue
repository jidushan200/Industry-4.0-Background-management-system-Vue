<template>
  <div>
    ...
    <purchase-delivery-modal ref="purchaseDeliveryModal" @search="getListData"></purchase-delivery-modal>
  </div>
</template>
<script>
...
import purchaseDeliveryModal from "./purchase-delivery-modal.vue";
export default {
  name: "page",
  computed: {
    access() {
  ...
  methods: {
    ...
    showDeliveryDetail(pkId) {
      const self = this;
      self.$refs.purchaseDeliveryModal.showModal(pkId);
    }
  }
};
</script>