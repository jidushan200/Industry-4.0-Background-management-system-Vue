...
export default {
            ...
            return h("div", [
              h(
                "a",
                {
                  on: {
                    click: () => {
                      this.showOperList(params.row.fullNumber);
                    }
                  }
                },
  ...
  methods: {
    ...
    exportData() {
      ...
      let toolMap = self.searchCondition.toolMap;
      ...
      window.location.href =
        getBaseUrl() + "/tool/tool-life-export?token=" + getToken() + para;
    }
  }
};
</script>
