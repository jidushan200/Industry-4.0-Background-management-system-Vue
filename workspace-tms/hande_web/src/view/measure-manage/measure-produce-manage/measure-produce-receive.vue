<template>
  <div>
    ...
    <measure-produce-receipt ref="measureProduceReceipt" @search="doSearch"></measure-produce-receipt>
    <produce-apply-model ref="produceApplyModel"></produce-apply-model>
  </div>
</template>
...
import produceApplyModel from "./produce-apply-model.vue";
import measureProduceReceipt from "./measure-produce-receipt.vue";
export default {
  components: {
    produceApplyModel,
    measureProduceReceipt
  },
  data() {
    return {
      toolMap: "",
  ...
  methods: {
    ...
    selectReport(pkId) {
      const self = this;
      self.$refs.produceApplyModel.showModal(pkId);
    },
    doPurchase(row) {
      const self = this;
      self.$refs.measureProduceReceipt.show(row);
    }
  }
};
</script>
